    ...
    async with async_playwright() as p:
        ...
        strike_script = """
            (name, delay) => {
                const getBlock = (n) => {
                    const lines = [
                        `__________________[${n}] DANGER 𝑷𝑨𝑷𝑨 𝑲𝑨 𝑮𝑼𝑳𝑨𝑴 🔱__________________`,
                        `__________________[${n}] 𝑻𝑬𝑹𝑰 𝑴𝑨𝑨 𝑲𝑨 𝑩𝑯𝑶𝑺𝑫𝑨 🔥__________________`,
                        `__________________[${n}] DANGER 𝑷𝑨𝑷𝑨 𝑵𝑬 𝑴𝑨𝑨 𝑪𝑯𝑶𝑫 𝑫𝑰 😂__________________`,
                        `__________________[${n}] 𝑹𝑼𝑵𝑫𝑰 𝑲𝑬 𝑩𝑨𝑪𝑪𝑯𝑬 𝑩𝑨𝑨𝑷 𝑺𝑬 𝑫𝑨𝑹 🤡__________________`,
                        `__________________[${n}] DANGER 𝑷𝑨𝑷𝑨 𝑻𝑬𝑹𝑨 𝑴𝑨𝑨𝑳𝑰𝑲 𝑯𝑨𝑰 👑__________________`,
